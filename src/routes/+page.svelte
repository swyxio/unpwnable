...
<p>
	This is a test of the "Unpwnable" prompt injection protection strategy (<a
		href="https://simonwillison.net/2022/Sep/12/prompt-injection/">what is prompt injection?</a
	>). We want to demonstrate that you can take normal product prompts, modify them slightly to
	<b
